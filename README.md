...
The project aims to bridge algorithmic pattern matching with practical search engine functionality while providing a foundation for future enhancements such as image resizing/compression and AI-generated image captions.
...
- Keyword-based image file search using the KMP string matching algorithm across filenames, tags, descriptions, and indexed file metadata
  ...
  - Local image search function allows users to upload their own image folders for searching and utility purposes.
